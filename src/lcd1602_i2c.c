...
// [주의] i2c_start, i2c_write 등 TWI(I2C) 기본 통신 함수가 구현되어 있다고
// 가정합니다.
...
void lcd_init(void) {
    ...
    lcd_write_pcf8574(0x30);
    lcd_pulse_enable(0x30);
    lcd_write_pcf8574(0x20);
    lcd_pulse_enable(0x20); // 4-bit mode 설정
